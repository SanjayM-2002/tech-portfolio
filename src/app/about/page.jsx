...
const AboutPage = () => {
  ...
  const skills = {
    ...
    frontend: ['Next.js', 'React.js', 'React Native', 'Redux', 'Tailwind CSS'],
      ...
      <div className='h-full overflow-scroll lg:flex' ref={containerRef}>
        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2'>
          ...
          <div className='flex flex-col gap-12 justify-center'>
            ...
            {/* BIOGRAPHY DESC */}
            <p className='text-lg'>
              Hey there! I'm Sanjay, a full stack developer with a passion for
              building scalable and user-friendly web applications. I'm a
              self-driven, passionate programmer with a deep interest in
              problem-solving and creating innovative solutions. With a solid
              foundation in both frontend and backend technologies, I thrive on
              turning complex challenges into streamlined, efficient
              applications.
            </p>
            {/* BIOGRAPHY QUOTE */}
          ...
          {/* SKILLS CONTAINER */}
          <div
            className='flex flex-col gap-12 justify-center w-96'
            ref={skillRef}
          >
            {/* SKILL TITLE */}
            <motion.h1
          ...
          >
            ...
            >
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-96'>
                  {/* JOB TITLE */}
                  <div className='bg-white p-2 font-semibold rounded-b-lg rounded-s-lg w-fit'>
                    Frontend Developer - Alts Wealth
                  </div>
